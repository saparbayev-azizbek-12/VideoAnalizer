"""
main.py - Fire & Smoke Detection veb ilovasi (FastAPI + ONNX)

Ishga tushirish:
    uvicorn main:app --reload --port 8001

Keyin brauzerda: http://127.0.0.1:8001
"""
...
app = FastAPI(title="Fire & Smoke Detection Monitor (ONNX)")
...
def _run_pipeline(job_id: str, input_path: Path) -> None:
    ...
    try:
        ...
        fire_detector.reencode_for_web(str(raw_output), str(web_output))
